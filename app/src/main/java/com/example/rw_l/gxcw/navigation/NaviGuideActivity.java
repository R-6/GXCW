...
public class NaviGuideActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NaviInitActivity.activityList.add(this);
        ...
        if (intent != null) {
            ...
            if (bundle != null) {
                ...
                mBNRoutePlanNode = (BNRoutePlanNode) bundle.getSerializable(NaviInitActivity.ROUTE_PLAN_NODE);
    ...
    protected void onDestroy() {
        ...
        NaviInitActivity.activityList.remove(this);
    ...
    private void createHandler() {
        ...
        if (hd == null) {
            ...
            hd = new Handler(getMainLooper()) {
                ...
                public void handleMessage(android.os.Message msg) {     //没找到传值msg哪来的
